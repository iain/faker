...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Manifest", "lib/extensions/array.rb", "lib/extensions/object.rb", "lib/faker.rb", "lib/faker/dutch_phone_numbers.txt", "lib/faker/phone_number.rb", "lib/faker/name.rb", "lib/faker/address.rb", "lib/faker/company.rb", "lib/faker/dutch_cities.txt", "lib/faker/dutch_first_names.txt", "lib/faker/version.rb", "lib/faker/dutch_last_names.txt", "lib/faker/lorem.rb", "lib/faker/internet.rb", "History.txt", "test/test_helper.rb", "test/test_faker.rb", "test/test_faker_name.rb", "test/test_faker_internet.rb", "Rakefile", "License.txt", "faker.gemspec"]
  s.has_rdoc = true
